...
# Live Check + Forum Check Yaptığımız Timeout'ları proxy-squid-v5'ten biraz farklı olan
...
# Connection behavior tuned so Squid decides slightly before the client
